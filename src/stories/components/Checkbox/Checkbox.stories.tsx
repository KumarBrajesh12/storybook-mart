...
const meta: Meta<typeof Checkbox> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A customizable checkbox component with a filled background, centered right icon, customizable label color, and customizable border radius.",
      },
    },
  },
  argTypes: {
    ...
    borderRadius: {
      control: "text",
      description:
        "Border radius of the checkbox, allowing customization from square to fully circular.",
...
export const CircularCheckboxWithoutRightMark: Story = {
  args: {
    isChecked: true,
    checkedColor: "#32CD32",
    iconColor: "#32CD32",
...
export const CheckboxWithQuantity: Story = {
  args: {
    isChecked: true,
    quantity : 394,
  },
